...
/**
 * An interface for the workAheadQueue. Specific workAheadQueue implementations
 * will implement this interface For use in ITCS 2214 Data Structures and
 * Algorithms UNC Charlotte, 2019
 * 
...
public interface WorkAheadQueueADT<T> extends QueueADT<T> {
     ...
     * Precondition: x must be less than 5, x must be less than size Note: indexing
     * from 0: 0 == front element, 1 == second element, etc.
     * 
     ...
     * 
     * @return ArrayList SinglyLinkedNode array list of nodes
     * @throws EmptyCollectionException if the queue is empty
     */
    public ArrayList<SinglyLinkedNode<T>> firstThreeNodes() throws EmptyCollectionException;
